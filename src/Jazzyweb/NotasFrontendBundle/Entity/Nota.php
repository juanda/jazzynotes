 ...
 * @ORM\Entity(repositoryClass="Jazzyweb\NotasFrontendBundle\Entity\NotaRepository")
 */
class Nota {
     ...
     */
    public function addEtiqueta(\Jazzyweb\NotasFrontendBundle\Entity\Etiqueta $etiquetas) {
